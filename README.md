...
- 受け取ったファイルをFinderへ再ドラッグして持っていける（フォーカスが当たっていない状態からでも1クリックで取り出し可能）
- Cmd/Shiftクリックで複数選択し、まとめてドラッグアウトできる
- ゴミ箱に移動したファイル・フォルダは自動でシェルフから消える
- トラックパッドの二本指タッチ（クリック不要）でウィンドウを移動できる
